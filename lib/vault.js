   ...
   async handleAccountCommand(subsystem_command,subsystem_option)
    ...
    async handleConfigCommand(subsystem_command,subsystem_option)
    {
      ...
      if(subsystem_command === 'cpu_threads' )
      {
        ...
        if(subsystem_command === 'throttle' )
        {
            this.setThrottle(subsystem_option);
            this.saveVaultData(  );

        }

        if(subsystem_command === 'solution_engine' )
        {
            this.setSolutionEngine(subsystem_option);
            this.saveVaultData(  );
      ...
      if(subsystem_command === 'list' )
      {
        ...
        console.log('Throttle:', this.getThrottle())
    ...
    setThrottle(throttle)
    {
        ...
        vaultData.throttle = throttle;
        console.log('Set throttle count: ', throttle);
    },

    setSolutionEngine(engine)
    {
        vaultData.solution_engine = engine;
    },
    ...
    getThrottle()
    {
        return vaultData.throttle;
    },

    getSolutionEngine()
    {
        return vaultData.solution_engine
    },
